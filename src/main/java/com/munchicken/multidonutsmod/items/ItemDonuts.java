...
public abstract class ItemDonuts extends ItemFood{

    private PotionEffect[] effects;

    public ItemDonuts(String name, int healAmount, float saturationModifier, boolean wolvesFavourite, PotionEffect... effects) {
